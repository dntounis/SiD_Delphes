############################################################
# DSiD_o2_v04: Delphes card with SiD performance parameters
# For SiD version o2_v04 
# Developer: Dimitris Ntounis, 
#based on a previous card by Chris Potter
# DSiD does not enforce electron, muon and photon isolation
# DSiD_iso enforces electron, muon and photon isolation
