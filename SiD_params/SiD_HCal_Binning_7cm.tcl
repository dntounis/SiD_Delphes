...
# Cell size: assume 7 cm x 7 cm  up to eta max = 3
# ECal Barrel : rinner = 141.7 cm, router = 249.3 cm --> r_mid = 195.5 cm


# DeltaEtaPhi = cell_size / r_mid = 7e-2 / 195.5e-2 = 0.035




# Number of bins in eta = 2*3.0 / 0.035 = 170
# Number of bins in phi = 2*pi / (0.035*cosh(1.5)) ~ 76
